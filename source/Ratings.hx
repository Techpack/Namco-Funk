...
class Ratings
{
    public static function GenerateLetterRank(accuracy:Float) // generate a letter ranking
    {
        ...
        if (PlayState.misses == 0 && PlayState.bads == 0 && PlayState.ouchs == 0 && PlayState.goods == 0) // Marvelous (SICK) Full Combo
            ranking = "(MFC)";
        else if (PlayState.misses == 0 && PlayState.bads == 0 && PlayState.ouchs == 0 && PlayState.goods >= 1) // Good Full Combo (Nothing but Goods & Sicks)
            ranking = "(GFC)";
    ...
    public static function CalculateRating(noteDiff:Float, ?customSafeZone:Float):String // Generate a judgement through some timing ouch
    {
